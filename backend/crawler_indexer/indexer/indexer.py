...
def index_documents():
    ...
    df_existing = storage.get_df_batch(terms)  # bạn cần implement hàm này trong storage
    ...
    storage.upsert_index_batch(upsert_records)  # bạn cần implement hàm này trong storage
